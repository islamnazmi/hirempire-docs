...
Access Hirempire AI from the **dashboard** — click the AI chat icon in the sidebar or header.
...
**Access and Setup**:
1. **Navigate to AI**: Go to [hirempire.com/ai](https://app.hirempire.com/dashboard/ai)
...
1. **[Access Hirempire AI](https://app.hirempire.com/dashboard/ai)** - Start your first conversation
2. **[Review Your Jobs](/core-features/jobs)** - Ensure job details are comprehensive for better AI context
3. **[Check Candidates](/candidates/candidates)** - Have candidate data ready for AI analysis
4. **[Upgrade Your Plan](/subscription)** - Ensure access to AI features (paid plans only)

### Related Features

After using Hirempire AI, explore:
- **[AI Screening](/ai-features/ai-screening)** - Automated candidate evaluation
- **[Automated Follow-ups](/core-features/automated-follow-ups)** - Streamline candidate communication
- **[Advanced Candidate Management](/candidates/candidates)** - Organize insights from AI conversations
