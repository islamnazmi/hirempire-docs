...
- Link to [AI Screening dashboard](/ai-screening) for comprehensive analysis
...
1. **[Set up AI Screening](/ai-screening)** - Get automated candidate insights (paid plans)
2. **[Configure Auto Follow-ups](/automated-follow-ups)** - Automate candidate communication
3. **[Analyze Job Performance](/jobs)** - Review which jobs and sources perform best