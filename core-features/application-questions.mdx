...
1. **[Test Your Application](/core-features/jobs)** - Apply to your own job to test the candidate experience
2. **[Review Applications](/candidates/candidates)** - See how question responses appear in candidate profiles
3. **[Analyze Performance](/core-features/jobs)** - Monitor application completion and response quality
4. **[Use AI Insights](/ai-features/ai-screening)** - Leverage question data for better candidate screening (paid plans)